...
public class TtlHashMap<K, V> implements Map<K, V>, TtlHandler<K>
{
    ...
    public Set<K> keySet() {
        this.clearExpired();
        return Collections.<K>unmodifiableSet((Set<? extends K>)this.store.keySet());
    }

    @Override
    public Collection<V> values() {
        this.clearExpired();
        return Collections.<V>unmodifiableCollection((Collection<? extends V>)this.store.values());
    }

    @Override
    public Set<Entry<K, V>> entrySet() {
        this.clearExpired();
        return Collections.<Entry<K, V>>unmodifiableSet((Set<? extends Entry<K, V>>)this.store.entrySet());
    }
