package net.latinplay.practice.util.timer.impl;
...
import net.latinplay.practice.util.timer.PlayerTimer;
...
public class EnderpearlTimer extends PlayerTimer implements Listener
{
    ...
    protected void handleExpiry(final Player player, final UUID playerUUID) {
        ...
        player.sendMessage(ChatColor.GREEN + "Ya puedes usar de nuevo el enderpeal.");
    }
    ...
    public void onPlayerInteract(final PlayerInteractEvent event) {
        ...
        if (event.getItem().getType() == Material.ENDER_PEARL) {
            ...
            if (cooldown > 0L) {
                ...
                player.sendMessage(ChatColor.YELLOW + "§3§lTiempo enderpearl: §f" + ChatColor.WHITE + DurationFormatUtils.formatDurationWords(cooldown, true, true));
