package net.latinplay.practice.util.timer;

import net.latinplay.practice.util.timer.event.TimerExtendEvent;
import net.latinplay.practice.util.timer.event.TimerStartEvent;
import java.util.function.Predicate;
import org.bukkit.Bukkit;
import net.latinplay.practice.util.timer.event.TimerPauseEvent;
import org.bukkit.event.Event;
import net.latinplay.practice.util.timer.event.TimerClearEvent;
