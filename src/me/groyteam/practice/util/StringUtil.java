...
public final class StringUtil
{
    ...
    static {
        NO_PERMISSION = ChatColor.RED + "Comando desconocido.";
        ...
        VOWELS = Arrays.<String>asList("a", "e", "u", "i", "o");
    }
    ...
    public static String buildMessage(final String[] args, final int start) {
        ...
        return ChatColor.stripColor(String.join(" ", (CharSequence[])Arrays.<String>copyOfRange(args, start, args.length)));
    }
